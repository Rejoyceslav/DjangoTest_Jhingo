...
SECRET_KEY = 'django-insecure-j!icd1&f+bt2tqf91*!27yrplv^2oqh%hc%e1c_u&b(cuwu@-f'
...
MEDIA_URL = '/img/'  # img folder is inside static folder, it's somehow inheriting it
